...
#define CRYPTO_SECRETKEYBYTES  10240     // sizeof(s)
...
int crypto_kem_dec_Frodo640(unsigned char *ssp,unsigned char *ss, const unsigned char *ct, const unsigned char *sk);
