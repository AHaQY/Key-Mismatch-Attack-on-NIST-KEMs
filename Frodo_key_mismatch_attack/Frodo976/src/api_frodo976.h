...
#define CRYPTO_SECRETKEYBYTES  15616     // sizeof(s)
...
int crypto_kem_dec_Frodo976(unsigned char *ssp,unsigned char *ss, const unsigned char *ct, const unsigned char *sk);
